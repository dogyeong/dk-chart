...
export default class TimeAxis extends Canvas {
  ...
  public draw(candles: Candle[], firstCandleIndex: number, lastCandleIndex: number) {
    ...
    this.timeLines = visibleCandles.reduce<TimeLine[]>((res, candle, idx) => {
